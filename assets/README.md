...
- `logo.svg` / `logo.png` — event logo
- `banner.png` — social/repo banner (1280×640 recommended)
- `slide-template.pptx` / link — demo slide template for teams

## Usage

- Participants may use these assets in their project READMEs, demo slides, and submission materials.
