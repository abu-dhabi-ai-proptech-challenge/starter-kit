...
**Can I use local / open-weight models?**
Yes. Ollama, llama.cpp, Hugging Face transformers — all fine.

**Can I use the sample data however I want?**
...
**Can we edit our submission after the deadline?**
Typo and broken-link fixes only. Substantive post-deadline changes aren't considered.
